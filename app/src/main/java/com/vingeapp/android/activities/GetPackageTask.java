 ...
 */
public class GetPackageTask extends AsyncTask<Void, Void, Void> implements GreenBotMessageKeyIds {
    ...
    public GetPackageTask(Context context, ArrayList<PInfo> pInfos) {
